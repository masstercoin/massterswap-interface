...
import { ButtonGray, ButtonOutlined, ButtonPrimary, ButtonOutlinedWhiteOpaque } from 'components/Button'
...
export default function Pool() {
  document.body.style.backgroundImage = "url('bgs/1.jpeg')"
          ...
          <AutoColumn gap="lg" style={{ width: '100%' }}>
            <TitleRow style={{ marginTop: '1rem' }} padding={'0'}>
              <TYPE.body fontSize={'20px'}>
                <Trans><div style={{ color: '#ffffff' }}>Pools Overview</div></Trans>
              </TYPE.body>
              <ButtonRow>
                {showV2Features && (
                  <Menu
