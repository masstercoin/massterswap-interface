          ...
          <CardSection>
            <AutoColumn gap="md">
              ...
              <ExternalLink
                ...
                target="_blank"
                href="https://masster.org/liquidity"
              >
                <TYPE.white fontSize={14}>
          ...
          <AutoColumn gap="lg" justify="center">
            <AutoColumn gap="md" style={{ width: '100%' }}>
              <TitleRow style={{ marginTop: '1rem' }} padding={'0'}>
                <HideSmall>
                  <TYPE.mediumHeader style={{ marginTop: '0.5rem', justifySelf: 'flex-start' }}>
                    <Trans><div style={{ color: '#ffffff' }}>Your V2 liquidity</div></Trans>
                  </TYPE.mediumHeader>
                </HideSmall>
                <ButtonRow>
              ...
              {!account ? (
                <Card padding="40px">
                  <TYPE.body color={theme.text3} textAlign="center">
                    <Trans><div style={{ color: '#ffffff' }}>Connect to a wallet to view your liquidity.</div></Trans>
                  </TYPE.body>
                </Card>
              ) : v2IsLoading ? (
                <EmptyProposals>
