...
import { ButtonConfirmed, ButtonError, ButtonGray, ButtonLight, ButtonPrimary, ButtonSwapConnectWallet } from '../../components/Button'
import { GreyCard } from '../../components/Card'
import { AutoColumn, ConnectWalletAutoColumn } from '../../components/Column'
...
export default function Swap({ history }: RouteComponentProps) {
  document.body.style.backgroundImage = "url('bgs/0.jpeg')"
              ...
              <>
                <AutoRow justify="space-between" style={{ padding: '0 1rem' }}>
                  <ArrowWrapper clickable={false}>
                    <ArrowDown size="16" color={theme.arrowDown} />
                  </ArrowWrapper>
            ...
            <div>
              {swapIsUnsupported ? (
                ...
                <>
                  ...
                  <ButtonSwapConnectWallet onClick={toggleWalletModal}>
                    <Trans>Connect Wallet</Trans>
                  </ButtonSwapConnectWallet>
                </>
              ) : showWrap ? (
