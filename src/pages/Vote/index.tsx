...
export default function Vote() {
  document.body.style.backgroundImage = "url('bgs/2.jpeg')"
    ...
    <>
      <PageWrapper gap="lg" justify="center">
              ...
              <AutoColumn gap="md">
                <RowBetween>
                  <TYPE.white fontWeight={600}>
                    <Trans>Massterswap Governance</Trans>
                  </TYPE.white>
                </RowBetween>
                <RowBetween>
                  <TYPE.white fontSize={14}>
                    <Trans>
                      Masster tokens represent voting shares in Masster governance. You can vote on each proposal yourself
                ...
                <ExternalLink
                  ...
                  href="https://masster.org/governance"
                  target="_blank"
                >
                  <TYPE.white fontSize={14}>
                    <Trans>Read more about Masster governance</Trans>
                  </TYPE.white>
                </ExternalLink>
              </AutoColumn>
            </CardSection>
        ...
        <TopSection gap="2px">
          <WrapSmall>
            <TYPE.mediumHeader style={{ margin: '0.5rem 0.5rem 0.5rem 0', flexShrink: 0 }}>
              <Trans><div style={{ color: '#ffffff' }}>Proposals</div></Trans>
            </TYPE.mediumHeader>
        ...
        <TYPE.subHeader color="text3">
          <Trans><div style={{ color: '#ffffff' }}>A minimum threshold of 0.25% of the total UNI supply is required to submit proposals</div></Trans>
        </TYPE.subHeader>
      </PageWrapper>
      <SwitchLocaleLink />
    </>
