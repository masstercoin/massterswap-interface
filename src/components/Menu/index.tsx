...
const StyledMenuIconNoHover = styled(MenuIcon)`
  path {
    stroke: ${({ theme }) => theme.text1};
  }
`

const StyledMenuIconHover = styled(MenuIcon)`
  path {
    stroke: #ea6ce1;
  }
`
...
export default function Menu() {
  ...
  const [menuButtonIsHover, setMenuButtonIsHover] = useState(false)

  return (
    // https://github.com/DefinitelyTyped/DefinitelyTyped/issues/30451
    <StyledMenu ref={node as any}>
      <StyledMenuButton onClick={toggle} onMouseEnter={() => setMenuButtonIsHover(true)} onMouseLeave={() => setMenuButtonIsHover(false)}>
        {(menuButtonIsHover === true || open === true) && <StyledMenuIconHover />}
        {(menuButtonIsHover === false && open === false) && <StyledMenuIconNoHover />}
      </StyledMenuButton>
        ...
        (() => {
          switch (menu) {
            ...
            default:
              return (
                <MenuFlyout>
                  <MenuItem href="https://masster.org/about">
                    <div>
                      <Trans>About</Trans>
                    </div>
                    <Info opacity={0.6} size={16} />
                  </MenuItem>
                  <MenuItem href="https://docs.masster.org">
                    <div>
                      <Trans>Docs</Trans>
                    </div>
                    <BookOpen opacity={0.6} size={16} />
                  </MenuItem>
                  <MenuItem href="https://masster.org/code">
                    <div>
                      <Trans>Code</Trans>
                    </div>
                    <Code opacity={0.6} size={16} />
                  </MenuItem>
                  <MenuItem href="https://masster.org/discord">
                    <div>
                      <Trans>Discord</Trans>
                    </div>
